...
\begin{table}[!htb]
\centering
\caption{与现有方法在 ODIR Off-site 和 On-site 上的双目指标对比。红色表示各指标中的最优结果，蓝色表示次优结果。与 BFENet \hyperref[_Ref214903327]{{[}50{]}} 相比，所提方法虽然在 F1 和 AUC 两项指标上略低，但在 Kappa 上提升更明显，并在两个测试集上的 Final score 均取得了最优结果。}
